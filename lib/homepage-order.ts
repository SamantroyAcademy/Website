...
export const HOME_SECTIONS: HomeSectionMeta[] = [
  ...
  { key: "shorts", label: "Success Stories", hint: "Latest videos from the success stories channel", editHref: "/admin/shorts" },
  ...
  { key: "videos", label: "Educational Videos", hint: "Latest from the Samantroy Academy channel", editHref: "/admin/shorts" },
  { key: "google_reviews", label: "Google Reviews", hint: "Hidden until reviews are added", editHref: "/admin/google-reviews" },
  { key: "instagram", label: "Social", hint: "Latest Instagram and Facebook videos, and follow links" },
