...
const FIELDS: { key: string; label: string; hint?: string }[] = [
  ...
  { key: "youtube", label: "YouTube: Samantroy Academy channel", hint: "Classes, current affairs and information videos" },
  { key: "youtube2", label: "YouTube: Success stories channel", hint: "Prasanta Nayak's channel: selection and result videos" },
